<%-- 
    Document   : index.jsp
    Created on : 9 May 2024, 4:25:59 pm
    Author     : muazg
--%>
...
<body>
  ...
  <main>
    <div class="main">
      ...
      <div class="align-ads">
        <a href="turkiye.html">
          <div class="ads-box" onclick="location.href='turkiye.html';">
            <img src="image/turkiyeBallon.jpg" alt="TurkiyeBalloon" class="image" />
            <div class="caption">
              <p>
        ...
        <a href="switzerland.html">
          <div class="ads-box">
            <img src="image/verzascaSwiss.jpg" alt="TurkiyeBalloon" class="image" />
            <div class="caption">
              <p>
